...
export const  Thin = () => (
  <Modal trigger={<Button>underweight</Button>}>
    <Modal.Header>Get Bigger and healthy</Modal.Header>
    <Modal.Content image scrolling>
      <Image size='medium' src={require('./giphy.gif')} wrapped />

      <Modal.Description>
        <Header>These exercices and diet will help you gain weight and muscles muscles quickly</Header>
